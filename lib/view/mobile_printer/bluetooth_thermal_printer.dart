...
class BluetoothThermalPrinterPage extends StatefulWidget {
  const BluetoothThermalPrinterPage({Key? key}) : super(key: key);

  @override
  _BluetoothThermalPrinterPageState createState() => _BluetoothThermalPrinterPageState();
}

class _BluetoothThermalPrinterPageState extends State<BluetoothThermalPrinterPage> {
