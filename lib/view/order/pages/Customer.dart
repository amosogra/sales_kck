...
class _CustomerState extends State<Customer> {
  ...
  TermModel termModel = new TermModel(termId: 0, companyCode: '', displayTerm: '', terms: '', isActive: 0);
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      setState(() {
        if (widget.saleOrderModel.companyCode.isEmpty) {
          ...
          customerModel = new CustomerModel(
              custId: widget.saleOrderModel.soId,
              companyCode: widget.saleOrderModel.companyCode,
              accNo: widget.saleOrderModel.custAccNo,
              name: widget.saleOrderModel.custName,
              addr1: widget.saleOrderModel.invAddr1,
              addr2: widget.saleOrderModel.invAddr2,
              addr3: widget.saleOrderModel.invAddr3,
              addr4: widget.saleOrderModel.invAddr4,
              attention: widget.saleOrderModel.attention,
              defDisplayTerm: widget.saleOrderModel.displayTerm,
              taxType: widget.saleOrderModel.taxAmt,
              phone1: "",
              phone2: "",
              isActive: 1,
              rev: 0,
              deleted: 0,
              docNumber: widget.saleOrderModel.docNo,
              docDate: widget.saleOrderModel.docDate);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("${widget.saleOrderModel.companyCode.isEmpty ? 'Add Customer Info' : 'Customer Info'}"),
      ),
          ...
          child: Column(
            ...
            children: [
              ...
              CustomerItemView(
                  ...
                  title: customerModel != null ? customerModel.name + " - " + customerModel.accNo : "",
                  onTap: () {
                    if (widget.isEdit) {
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Text(customerModel.docNumber.isEmpty ? "Doc Number" : customerModel.docNumber,
                              style: TextStyle(
                                fontSize: 14,
                                color: customerModel.docNumber.isEmpty ? MyColors.textBorderColor : MyColors.textColor,
                                fontFamily: 'Ionicons',
                              )),
                        ),
                        Divider(
                          ...
                          children: [
                            Expanded(
                              ...
                              child: Text(customerModel.docDate.isEmpty ? "Doc Date" : customerModel.docDate,
                                  style: TextStyle(
                                    fontSize: 14,
                                    color: customerModel.docDate.isEmpty ? MyColors.textBorderColor : MyColors.textColor,
                                    fontFamily: 'Ionicons',
                                  )),
                            )),
                            Icon(
              ...
              CustomerItemView(hintText: "Address 1", title: customerModel.addr1, onTap: () {}),
              CustomerItemView(hintText: "Address 2", title: customerModel.addr2, onTap: () {}),
              CustomerItemView(hintText: "Address 3", title: customerModel.addr3, onTap: () {}),
              CustomerItemView(hintText: "Address 4", title: customerModel.addr4, onTap: () {}),
              Container(
              ...
              Container(
                ...
                child: Text(customerModel.phone1.isEmpty ? Strings.phone_number : customerModel.phone1,
                    style: TextStyle(
                      fontSize: 14,
                      color: customerModel.phone1.isEmpty ? MyColors.textBorderColor : MyColors.textColor,
                      fontFamily: 'Ionicons',
                    )),
              ),
              Divider(
              ...
              CustomerItemInput(
                controller: remark1Controller,
                focusNode: remark1FocusNode,
                nextFocusNode: remark2FocusNode,
                hint: "Remark 1",
                onChange: (value) {
                  setState(() {
                    remark1 = value!;
              ...
              CustomerItemInput(
                  controller: remark2Controller,
                  focusNode: remark2FocusNode,
                  nextFocusNode: remark3FocusNode,
                  hint: "Remark 2",
                  onChange: (value) {
                    remark2 = value!;
                  }),
              CustomerItemInput(
                  controller: remark3Controller,
                  focusNode: remark3FocusNode,
                  nextFocusNode: remark4FocusNode,
                  hint: "Remark 3",
                  onChange: (value) {
                    remark3 = value!;
                  }),
              ...
              if (widget.isEdit == true && customerModel.custId != 0)
                Container(
                  margin: EdgeInsets.only(top: 10),
                  child: LoginButton(
                    title: Strings.next,
